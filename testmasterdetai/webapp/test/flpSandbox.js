		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#testmasterdetai-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testmasterdetai-display": {
								"semanticObject": "testmasterdetai",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testmasterdetai",
									"url": sap.ui.require.toUrl("testmasterdetai")
								}
							}
						}
					}
