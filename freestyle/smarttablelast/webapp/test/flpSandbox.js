		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Smart Table",
									"targetURL": "#smarttablelast-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smarttablelast-display": {
								"semanticObject": "smarttablelast",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smarttablelast",
									"url": sap.ui.require.toUrl("smarttablelast")
								}
							}
						}
					}
